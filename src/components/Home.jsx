                ...
                <div className="container h-100">
                    <div className="row h-100 align-items-center justify-content-center">
                        <div className="col-lg-8  text-center">
                            <h1 className="text-white font-weight-bold display-3 mb-4">Welcome to EDUVERSE</h1>
                            <p className="text-white-75 font-weight-light lead mb-5">Connecting LBSCEK Alumnis Across The Globe</p>
                            ...
                            {isLoggedIn && !isAdmin && !isStudent && <Link className="btn btn-info  ms-2   btn-xl" to="account">Profile</Link>}
                            {isLoggedIn  && isStudent && <Link className="btn btn-info  ms-2   btn-xl" to="student">Profile</Link>}
                        </div>
                    </div>
                </div>
            </header>
            ...
            <section className={`page-section bg-${theme}`} id="alumni-benefits">
                <div className="container">
                    <div className="text-center">
                        ...
                        <h3 className=" card-title text-muted">As a member of the global LBSCEK alumni network, you have access to a variety of exclusive services and benefits.</h3>
                    </div>
                    <div className="row">
