                        ...
                        <ul className="navbar-nav ml-auto my-2 my-lg-0">
                            ...
                            {isLoggedIn ? (<li className="nav-item dropdown">
                                ...
                                <ul className="dropdown-menu ">
                                    ...
                                    {!isAdmin && !isStudent && <li><Link onClick={toggleMenu} className="dropdown-item" to="account" ><FaCog /> Manage Account</Link></li>}
                                    {isStudent && <li><Link onClick={toggleMenu} className="dropdown-item" to="student" ><FaCog /> Student info </Link></li>}
