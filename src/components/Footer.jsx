    ...
    <>
      <footer className={footerClasses}>
        <div className="container">
          ...
          <div className="row">
            <div className="col-lg-4 ml-auto text-center mb-5 mb-lg-0">
              ...
              <div className="text-${theme === 'dark' ? 'white' : 'black'}">(+91) 7736343139</div>
            </div>
            <div className="col-lg-4 mr-auto text-center">
              <FaEnvelope className={iconClasses} />
              <a className="d-block" href="mailto:eduverse@gmail.com">eduverse@gmail.com</a>
            </div>
          </div>
        </div>
        <br />
        <div className="container">
          ...
          <div className={`small text-center text-${theme === 'dark' ? 'gray-400' : 'muted'}`}>
            Copyright © 2025 - EDUVERSE |  {devfooter} <a
             // href="https://junaidrana.vercel.app/"
              target="_blank"
              rel="noreferrer"
            >
              EduVerse<GoVerified style={{ fontSize: "12px", marginLeft: "2px", color:"#03b3ff" }} />
            </a>
          </div>
        </div>
      </footer>
